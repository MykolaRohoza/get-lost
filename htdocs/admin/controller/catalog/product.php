...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_short_size'] = $this->language->get('entry_short_size');
		$data['entry_price_holder'] = $this->language->get('entry_price_holder');
		...
		$data['tab_price_holder'] = $this->language->get('tab_price_holder');
		...
		if (isset($this->request->post['short_size'])) {
			$data['short_size'] = $this->request->post['short_size'];
		} elseif (!empty($product_info)) {
			$data['short_size'] = $product_info['short_size'];
		} else {
			$data['short_size'] = '';
		}
		...
		if (!empty($product_info)) {
			$filter_data = array('product_id' => $product_info['product_id']);
			
			$data['linked_products'] = $this->load->controller('catalog/price_holder/getProductForm', $filter_data);
		} else {
