...
class ModelCatalogProduct extends Model {
	public function addProduct($data) {
		...
		if (isset($data['linked_products'])) {
			...
			$this->model_catalog_price_holder->linkPriceHolderProductsToProduct($data['linked_products'], $product_id);
		}
	...
	public function editProduct($product_id, $data) {
		...
		if (isset($data['linked_products'])) {
			$this->load->model('catalog/price_holder');
			$this->model_catalog_price_holder->deleteLinkedPriceHolderProducts($product_id);
			$this->model_catalog_price_holder->linkPriceHolderProductsToProduct($data['linked_products'], $product_id);
		}
		$this->cache->delete('product');
