...
<div id="content">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-price_holder" data-toggle="tab"><?php echo $tab_price_holder; ?></a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-year"><?php echo $entry_year; ?></label>
                <div class="col-sm-10">
                    <input type="text" name="year" value="<?php echo $year; ?>" placeholder="<?php echo $entry_year; ?>" id="input-year" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-short_size"><?php echo $entry_short_size; ?></label>
                <div class="col-sm-10">
                    <input type="text" name="short_size" value="<?php echo $short_size; ?>" placeholder="<?php echo $entry_short_size; ?>" id="input-short_size" class="form-control" />
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-price_holder">
				<div class="well" id="search">
				  <div class="row">
					<div class="col-sm-4">
					  <div class="form-group">
						<label class="control-label" for="input-price_holder-name"><?=$entry_name?></label>
						<input type="text" name="filter_name" placeholder="<?=$entry_name?>" id="input-price_holder-name" class="form-control"
							   value="<?php echo isset($product_description[$config_language_id]) ? $product_description[$config_language_id]['name'] : ''; ?>" >
					  </div>
					  <div class="form-group">
						<label class="control-label" for="input-price_holder-model"><?=$entry_model?></label>
						<input type="text" name="filter_model" value="<?=$model?>" placeholder="<?=$entry_model?>" id="input-price_holder-model" class="form-control">
					  </div>
					</div>
					<div class="col-sm-4">
					  <div class="form-group">
						<label class="control-label" for="input-price_holder-year"><?=$entry_year?></label>
						<input type="text" name="filter_year" value="<?=$year?>" placeholder="<?=$entry_year?>" id="input-price_holder-price" class="form-control">
					  </div>
					  <div class="form-group">
						<label class="control-label" for="input-price_holder-short_size"><?=$entry_short_size?></label>
						<input type="text" name="filter_short_size" value="<?=$short_size?>" placeholder="<?=$entry_short_size?>" id="input-price_holder-short_size" class="form-control">
					  </div>
					</div>
					<div class="col-sm-4">
						<div class="form-group">
							<label class="control-label" for="input-price_holder-manufacturer"><?=$entry_manufacturer?></label>
							<input type="text" name="filter_manufacturer" value="<?=$manufacturer?>" placeholder="<?=$entry_manufacturer?>" id="input-price_holder-manufacturer" class="form-control">
						</div>
					</div>
					<div class="col-sm-12">
              ...
              <div class="table-responsive">
                ...
                <table id="price_holder-searched_products" class="table table-striped table-bordered table-hover">
                </table>
              </div>
              <div class="table-responsive">
				  <legend>Уже привязанные товары</legend>
                <table id="price_holder-linked_products" class="table table-striped table-bordered table-hover">
					<?=$linked_products?>
                </table>
              </div>
  ...
  <script type="text/javascript"><!--
	$('#button-filter').on('click', function(){
		var get_data ='', route = 'index.php?route=catalog/price_holder/search', $filters = $('#search').find('input, select');
		$.each($filters, function(key, filter){
			var $filter = $(filter);
			if($filter.val() !== ''){
				get_data += '&' + $filter.attr('name') + '=' + encodeURIComponent($filter.val());
			} 
		});
		$('#price_holder-searched_products').load(route + '&token=<?=$token?>' + get_data);

	});
	  
	  
function ajaxHelper(route, ajax_data, handler)
{
	$.ajax({
		async: false,
		cache: false,
